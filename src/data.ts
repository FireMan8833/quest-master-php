...
export const questData: QuestStep[] = [
  ...
  },
  {
    ...
    explanation: "Точно! Нам нужен уникальный ID, логин, email, и самое главное — хеш пароля, а не сам пароль в открывом виде!"
  },
  {
    id: 3,
  ...
  {
    id: 11,
    dialog: "ВНИМАНИЕ! Сигнал тревоги! На шлюз базы данных напал КИБЕРЧЕРВЬ SQL-ИНЪЕКТОР! Он пытается прочесть пароли и стереть таблицы! Боб в панике!",
    question: "СУПЕРБОСС: Отрази атаку SQL-инъекций! Обезвреживай только опасные эксплойты!",
    type: "mini_game",
    miniGameType: "boss_sql",
    explanation: "УРА! Киберчервь побежден, его несанкционированные запросы заблокированы файрволом! Теперь база данных в полной безопасности. Идём дальше!"
  },
  // --- END OF BOSS 1 ---
  {
    id: 12,
  ...
  },
  {
    ...
    explanation: "UPDATE обновит существующие записи. Не забудьте WHERE, иначе обновите цены у всех туров!"
  },
  {
    id: 18,
  ...
  {
    id: 22,
    dialog: "О НЕТ! Новая напасть! Злобные СЛИЗНИ УТЕЧКИ ПАМЯТИ (Memory Leaks) проникли в оперативную память (RAM) нашего сервера! Они пожирают буферы, и сервер может упасть с ошибкой Out Of Memory!",
    question: "СУПЕРБОСС 2: Сборщик Мусора! Быстро кликай по фиолетовым слизням для ручной очистки ОЗУ!",
    type: "mini_game",
    miniGameType: "boss_ram",
    explanation: "НЕВЕРОЯТНО! Ты запустил ручной Garbage Collector и полностью очистил оперативную память. Сервер работает супер-быстро!"
  },
  // --- END OF BOSS 2 ---
  {
    id: 23,
  ...
  {
    id: 33,
    dialog: "ДЕРЖИСЬ КРЕПЧЕ! Вражеский ботнет пытается положить наш сервер! Миллионы вредоносных пакетов отправляются ежесекундно, чтобы вызвать перегрузку процессора (DDoS)!",
    question: "СУПЕРБОСС 3: Сетевой Шлюз! Блокируй только вредоносные бот-пакеты (🤖), кликая по ним до того, как перегреется CPU!",
    type: "mini_game",
    miniGameType: "boss_ddos",
    explanation: "ФЕНОМЕНАЛЬНО! Атака DDoS успешно отражена! Фильтр шлюза задержал ботнет, и ядра процессора вернулись в холодное зеленое состояние!"
  },
  // --- END OF BOSS 3 ---
  {
    id: 34,
  ...
  // --- BOSS 4 LEVEL - THE FINALE ---
  {
    id: 44,
    dialog: "ПОТРЯСАЮЩЕ! Весь проект запущен и работает... Но подождите! Из глубин глобальной сети проснулся РАЗРУШИТЕЛЬ ИИ! Он хочет стереть весь наш код и запустить глобальный сбой сети! Это финальная битва за интернет!",
    question: "ФИНАЛЬНЫЙ СУПЕРБОСС: Деактивируй заражённые ИИ-разрушителем синапсы кода! Обезвреживай только ядра, отмеченные датчиком тревоги (⚠️)!",
    type: "mini_game",
    miniGameType: "boss_final",
    explanation: "ЛЕГЕНДАРНО! ХАКЕР ГОДА! Переворот в кибербезопасности! ИИ-Разрушитель успешно перезагружен в миролюбивый режим. Архитектура спасена, интернет спасен! Боб гордится тобой до слёз! ТЫ НАСТОЯЩИЙ СУПЕРГЕРОЙ-РАЗРАБОТЧИК!"
  }
];
